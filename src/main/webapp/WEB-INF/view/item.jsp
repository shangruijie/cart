    ...
    <div class="box">
        ...
        <div class="cent">
            ...
            <div class="clear" style="margin-top:20px;">
                ...
                <div class="num_box">
                    <input id="numInput" type="text" name="num" value="1" style="width:40px;height:32px;text-align:center;float:left">
                    <div class="rg">
...
<div class="Dbox1">
    ...
    <form action="saveCart.do" method="post" id="saveCartForm">
        ...
        <input type="text" name="tjshl" value="1" id="tjshlInput">
